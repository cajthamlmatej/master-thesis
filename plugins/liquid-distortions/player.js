...
<script>
    ...
    const params = {
        timeScale: minmax(${block.data.timeScale??0.4}, 0.1, 2.0),
        patternAmp: minmax(${block.data.patternAmp??12.0}, 0.0, 20.0),
        patternFreq: minmax(${block.data.patternFreq??0.5}, 0.0, 2.0),
        bloomStrength: minmax(${block.data.bloomStrength??1.0}, 0.0, 2.0),
        saturation: minmax(${block.data.saturation??0.85}, 0.0, 2.0),
        grainAmount: minmax(${block.data.grainAmount??0.2}, 0.0, 2.0),
        colorTintR: minmax(${block.data.colorTintR??1.0}, 0.0, 1.0),
        colorTintG: minmax(${block.data.colorTintG??1.0}, 0.0, 1.0),
        colorTintB: minmax(${block.data.colorTintB??1.0}, 0.0, 1.0),
        minCircleSize: minmax(${block.data.minCircleSize??3.0}, 0.0, 20.0),
        circleStrength: minmax(${block.data.circleStrength??1.0}, 0.0, 2.0),
        distortX: minmax(${block.data.distortX??5.0}, 0.0, 20.0),
        distortY: minmax(${block.data.distortY??20.0}, 0.0, 20.0)
    };
    ...
    window.addEventListener("message", function(event) {
        ...
        params.timeScale = minmax(data.timeScale??0.4, 0.1, 2.0);
        params.patternAmp = minmax(data.patternAmp??12.0, 0.0, 20.0);
        params.patternFreq = minmax(data.patternFreq??0.5, 0.0, 2.0);
        params.bloomStrength = minmax(data.bloomStrength??1.0, 0.0, 2.0);
        params.saturation = minmax(data.saturation??0.85, 0.0, 2.0);
        params.grainAmount = minmax(data.grainAmount??0.2, 0.0, 2.0);
        params.colorTintR = minmax(data.colorTintR??1.0, 0.0, 1.0);
        params.colorTintG = minmax(data.colorTintG??1.0, 0.0, 1.0);
        params.colorTintB = minmax(data.colorTintB??1.0, 0.0, 1.0);
        params.minCircleSize = minmax(data.minCircleSize??3.0, 0.0, 20.0);
        params.circleStrength = minmax(data.circleStrength??1.0, 0.0, 2.0);
        params.distortX = minmax(data.distortX??5.0, 0.0, 20.0);
        params.distortY = minmax(data.distortY??20.0, 0.0, 20.0);
