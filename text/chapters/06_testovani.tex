...
Během vývoje vzniklo \textbf{19}\todo{Kolik?} verzí aplikace včetně prototypu. 
...
\begin{longtable}{r|p{2cm}|p{2cm}|p{6cm}}
    \caption{Hodnocení průchodu scénářů účastníka 8}\label{tab:hodnoceniPruchoduUcastnika8}\\
...
Vytvořené rozšíření je dle původní dohody tedy na přidávání časovač (stopek) do snímků materiálu. 
Slečna přidala...
...
% - zjisteny podporovane prohlizece (zjisteno od uzivatelskeho testovani, funkci Vivaldi, Chrome, Chromium, Safari, Firefox, Edge, Brave, vše posledni verze, pouzivani i BrowserStack, zadne problemy) a testovani mnou na zarizenych mych, kamaradu a rodiny (Galaxy S10 Lite, Galaxy A51, Xiaomi Mi 8 Lite, Samsung Galaxy A33, Huawei P8 Lite, iPhone 13 Mini, iPhone 14 Pro, iPhone 16) a i desktopove (Mac verze NEJAKA, Windows 11, Linux Debian, Arch).
...
Vytvořené prezentace jsou jako lokální záloha uvedené v přiloženém archívu ve složce \verb|/examples/|\todo{zkontrolovat}.
...
% - pro otestovani platformy jsem vytvoril prezentace, ktere jsem pouzil ve vyuce
% - konkretne se jednalo o:
%    - Odborného semináře, Přípravy na vysokoškolské studium
%       - cílem hodiny bylo ukázat co si brzy maturujici studenti z predmetu odnesli
%       - nejcastejsi veci, ceho se boji, obecne well being
%       - spise klidna hodina, konecna
%    - Volitelný maturitní odborný předmět, Webového inženýrství
%       - cílem hodiny bylo opakovat termíny z webového backendu a tvorby v express
%       - jak se pracuje se vstupem, ze mu neni mozno verit
%       - opakovat zaklady relacnich databazi, dotazy a spravne navyky
%       - hodina plna latky, hodne zamereni se na to
      
% - prezentace jsem se snazil vytvorit v mem obycejnem stylu
% - hodne se zamerit na interaktivitu a vyuzit vsechny implementovane moznosti
% - zkouska primo ve vyuce, kdy jsem to testoval 24. 4. 2025 (seminar) a 28. 4. 2025 (web)
% - studenty jsem pozval do modu sledovani prezentace, aby mohli interagovat

% - reakce studentů - , doplnim
% - moje zpetna reakce - , doplnim

% - obecne potreba dalsi testovani, dalsi moznosti, aby byly nastroje jak delat vyuku lepsi