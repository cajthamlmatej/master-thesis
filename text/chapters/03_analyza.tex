...
RevealJS~\cite{revealjs} je knihovna a framework, která dovoluje tvořit prezentace pomocí zdrojového kódu v \texttt{HTML}. 
...
WebAssembly~\cite{webassembly} je nový způsob spouštění bezpečného kódu na webové stránce.
