...
Na těchto požadavcích jsou postaveny případy užití (viz sekce~\ref{chapter:analyza/uzivatelskePripady}), jež specifikují, jak bude aplikace využívána. 
...
\begin{description}
    ...
    Uživatel může provádět komplexní úpravy materiálu pomocí vestavěného editoru. Upravování je rozděleno do několika dílčích případů:
        ...
        \begin{description}
            ...
            Uživatel může ručně měnit vlastnosti bloků, jejich zobrazení, grafiku a specifické vlastnosti bloků. U interaktivních bloků lze definovat specifické akce, které se spustí při určité události (např. kliknutí, časovač, ...). Možné je také upravovat proměnné, nastavovat podmínky a další interaktivní chování.
