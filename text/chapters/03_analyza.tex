...
\begin{description}
    ...
    Schválená rozšíření budou k dispozici přímo v aplikaci pro instalaci kýmkoliv.
...
\begin{description}
    ...
    Výsledek musí být webová aplikace, která bude napsána ve validním HTML, CSS a JS.
