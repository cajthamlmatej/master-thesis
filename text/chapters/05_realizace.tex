...
\subsection{Moduly}\todo{chybi nejake}
...
\todo{neafektuje moznost uzivatele vklada to text. pole napr.}
...
\subsection{Přístup k API}\todo{asi mnohem vice rozepsat}
...
\subsection{Vykreslované bloky}\todo{vice popsat}
...
Obecně tento způsob není vhodný pro jednoduché nasazení a vyžadoval by velké zkušenosti s aplikací tak s propojením.
...
- dockerc ompose easy
- nemountuje se, jen ma nodemodules
