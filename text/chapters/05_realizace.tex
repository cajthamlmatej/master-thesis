...
\end{minted}
\caption{Zápis překladů ve formátu JSON}\label{code:zapisPrekladu}
\end{listing}
...
\begin{description}
    ...
    \item[data-export] Zpracování a přijímání požadavků pro vygenerování souboru osobních dat z~projektu.
...
\begin{description}
    \item[fetch] Dovoluje volat požadavky přímo jako stránka editoru (tj. s~CORS) na povolených doménách z~manifestu.
    \item[cache] Dovoluje rozšíření si pamatovat věci skrz spuštění.
    \item[plugin] Dovoluje vědět, kdo je aktuálním spouštěčem skriptu.
    \item[language] Dovoluje zjistit, jaký jazyk je aktuálně vybrán.
    \item[log] Dovoluje vypisovat věci do konzole pro lepší vývoj.
\end{description}
...
GitLab byl používán během procesu vývoje.
K publikování kódu jsem zvolil GitHub.
Repozitář je dostupný na: \url{https://github.com/cajthamlmatej/master-thesis}.
