...
Podobně data, která budou v databázi uložena, nemají jasně stanovenou strukturu a obecně se bude jednat o velmi komplexní objekty\todo{nekam dale odkazat?}.
I když budou na sebe data ukazovat\todo{viz datový model?}, jsou tyto propojení velmi triviální.
...
Prisma má avšak velké problémy s MongoDB a často je nutné velmi složitě\todo{footnote na issues?} nastavovat server.
