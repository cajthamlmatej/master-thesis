...
Jako webový framework pro klienta použiji knihovnu Vue, která je známá pro svoji jednoduchost, stabilitu a komunitu~\cite{potter_2023}.
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=0.9\textwidth,page=21]{media/04_navrh/navhoveObrazovky.pdf}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=0.9\textwidth,page=12]{media/04_navrh/navhoveObrazovky.pdf}
