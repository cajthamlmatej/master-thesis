...
Zadání z IS KOS obsahuje oproti verzi z aplikace Projects drobné nesrovnalosti, které nebyly fakultou opraveny před odevzdáním práce. 
Jedná se zejména o chybějící diakritiku (čárky nad písmenem \texttt{y}), podpisy a další náležitosti formálního charakteru.

\includepdf[pages={1-}, scale=0.8, offset=0 0]{zadani.pdf}