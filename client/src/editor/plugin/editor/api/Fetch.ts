...
/**
 * Represents a feature for performing HTTP fetch requests from the plugin.
 */
export class FetchApiFeature extends EditorPluginApiFeature {
    /**
     * Registers a `fetch` function into the JavaScript context for making HTTP requests.
     * 
     * @param obj - The QuickJS object to which the `fetch` function will be added.
