<template>
    <section :class="classes">
        ...
        <Button :disabled="props.page === 1" color="transparent" @click="changePage(props.page - 1)"><span v-t>components.pagination.previous</span>
        </Button>

        <Button :disabled="props.page === props.total || props.total === 0" color="transparent"
