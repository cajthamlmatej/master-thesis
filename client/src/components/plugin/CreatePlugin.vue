<template>
    <p class="title" v-t>page.plugins.new-plugin.title</p>
    ...
    <div class="flex flex-justify-space-between gap-1 flex-align-center py-1">
        <Select  :label="$t('page.plugins.new-plugin.icon.label')" v-model:value="data.icon" :choices="icons" class="select"></Select>
